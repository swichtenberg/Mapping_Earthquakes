...
// We create the tile layers for map background.
...
// Create layer groups to hold the data.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // Return the style data for each of earthquake plotted on the map. The magnitude of the earthquake is used to calculate color and radius.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  // Create a GeoJSON layer with the retrieved data that adds a circle to the map sets the style of the circle, and displays the magnitude and location of the earthquake
